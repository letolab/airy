...
from airy.core.files.uploadedfile import TemporaryUploadedFile, InMemoryUploadedFile
from airy.utils import importlib
...
def load_handler(path, *args, **kwargs):
    ...
    E.g.::
        >>> load_handler('airy.core.files.uploadhandler.TemporaryFileUploadHandler', request)
